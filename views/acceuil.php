...
<body style="overflow-x:hidden; width:auto;" class="px-0">


<section class="mt-0 " style="background-image: url('./views/img/bac.png');
...
<section class="container mb-5">
  ...
  <div class="carousel-inner mt-5">
    ...
    <div class="carousel-item active">
            ...
            <img src="views/img/livraison.jpg" class="card-img-top" alt="...">
    ...
    <div class="card d-block w-100" style="width: 18rem;">
            <img src="views/img/ramassage.jpg" class="card-img-top" alt="...">
            <div class="card-body text-center">
    ...
    <div class="carousel-item">
    <div class="card d-block w-100" style="width: 18rem;">
            <img src="views/img/stockage.jpg" class="card-img-top" alt="...">
            <div class="card-body text-center">
...
<footer  style=" color:white; background-color:#343BA8;">
        <div class="container ">
            ...
            <div class="row text-center">
                <div class="col-sm-4"> 
                    <img src="views/img/logo-rm.png" style="max-width:100px;" alt="">
